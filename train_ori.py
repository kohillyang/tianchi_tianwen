...
from models.Resnext_1d import resnext20
...
save_dir = '/media/gserver/models/tianwen/resnext20'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
logfile = '/media/gserver/models/tianwen/resnext20/trainlog.log'
trainlog(logfile)
