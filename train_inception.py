...
from models.inceptionV3_1d import inception_v3
...
# model prepare
resume = '/media/gserver/models/tianwen/inceptionV3_crop/weights-21-10500-[0.7797].pth'
...
save_dir = '/media/gserver/models/tianwen/inceptionV3_crop'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
logfile = '/media/gserver/models/tianwen/inceptionV3_crop/trainlog.log'
trainlog(logfile)
