...
__all__ = ['DenseNet', 'densenet119']


def densenet119(pretrained=False, **kwargs):
    model = DenseNet(num_init_features=2, growth_rate=10, block_config=(4, 6, 12, 16, 10, 8),
                     **kwargs)
...
class DenseNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.adaptive_avg_pool1d(out, output_size=(1,)).view(features.size(0), -1)
