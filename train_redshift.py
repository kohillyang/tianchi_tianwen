...
# model prepare
resume = None
model = densenet119(num_classes=4)
# model = MLPNet(num_classes=4,input_size=2600)
...
save_dir = '/media/gserver/models/tianwen/densenet119_redshift'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
logfile = '/media/gserver/models/tianwen/densenet119_redshift/trainlog.log'
trainlog(logfile)
